...
let FaceVerificationController = class FaceVerificationController {
    ...
    async verifyLiveFace(req, body) {
        const userId = req.user.sub;
        return this.faceVerificationService.verifyLiveFace(userId, body.imageBase64);
    }
    async verifyHeadMovements(req, body) {
        const userId = req.user.sub;
        return this.faceVerificationService.verifyHeadMovements(userId, body.leftImage, body.rightImage, body.upImage, body.downImage);
    }
};
exports.FaceVerificationController = FaceVerificationController;
__decorate([
    (0, common_1.Post)('verify-live'),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], FaceVerificationController.prototype, "verifyLiveFace", null);
__decorate([
    (0, common_1.Post)('verify-movements'),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], FaceVerificationController.prototype, "verifyHeadMovements", null);
