...
exports.CreateAuthDto = exports.UserRole = void 0;
...
__decorate([
    (0, class_validator_1.IsEmail)({}, { message: 'Veuillez fournir un email valide' }),
...
__decorate([
    (0, class_validator_1.IsEnum)(UserRole, { message: 'Le rôle doit être PASSENGER, DRIVER ou ADMIN' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
